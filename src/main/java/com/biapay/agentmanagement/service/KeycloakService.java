...
import com.biapay.agentmanagement.domain.UserType;
...
import static com.biapay.agentmanagement.config.Constants.USER_ID;
import static com.biapay.agentmanagement.config.Constants.USER_TYPE;
...
//
    ...
    if (result.getStatus() != 201) {
      ...
      throw new BIAPayRuntimeException("Error while creating user");
    }
